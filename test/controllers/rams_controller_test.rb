...
class RamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ram" do
    assert_difference('Ram.count') do
      post rams_url, params: { ram: { Manufacturer: @ram.Manufacturer, ModelName: @ram.ModelName, RamFrequency: @ram.RamFrequency, RamGeneration: @ram.RamGeneration, RamSize: @ram.RamSize } }
    end
  ...
  test "should update ram" do
    patch ram_url(@ram), params: { ram: { Manufacturer: @ram.Manufacturer, ModelName: @ram.ModelName, RamFrequency: @ram.RamFrequency, RamGeneration: @ram.RamGeneration, RamSize: @ram.RamSize } }
